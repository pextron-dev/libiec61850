 ...
 * client_example.c
 *
 * Buffered report IED550 example.
 */
...
main(int argc, char** argv)
{
    ...
    if (error == IED_ERROR_OK)
    {
        ...
        /* Read RCB values */
        ClientReportControlBlock rcb_1 = IedConnection_getRCBValues(con, &error, "S640/LLN0.BR.bcrbMMXU1", NULL);
        ...
        if (rcb_1)
        {
            ...
            IedConnection_installReportHandler(con, "S640/LLN0.BR.bcrbMMXU1", ClientReportControlBlock_getRptId(rcb_1),
